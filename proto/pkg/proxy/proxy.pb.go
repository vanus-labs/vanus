...
type LookupOffsetRequest struct {
	...
	EventlogId string `protobuf:"bytes,2,opt,name=eventlog_id,json=eventlogId,proto3" json:"eventlog_id,omitempty"`
...
func (x *LookupOffsetRequest) GetEventlogId() string {
	if x != nil {
		return x.EventlogId
	}
	return ""
...
func (x *GetEventRequest) GetEventlogId() string {
	if x != nil {
		return x.EventlogId
	}
	return ""
...
var file_proxy_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x6c, 0x6f, 0x67, 0x49,
	...
	0x6f, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x65, 0x76, 0x65,
