...
var file_raft_proto_rawDesc = []byte{
	...
	0x0a, 0x0b, 0x53, 0x65, 0x6e, 0x64, 0x4d, 0x73, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x0f, 0x2e,
	0x72, 0x61, 0x66, 0x74, 0x70, 0x62, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x16,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x28, 0x01, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x69, 0x6e, 0x6b, 0x61, 0x6c, 0x6c, 0x2d, 0x6c,
	0x61, 0x62, 0x73, 0x2f, 0x76, 0x73, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x6b, 0x67, 0x2f,
...
var file_raft_proto_depIdxs = []int32{
	0, // 0: linkall.vanus.raft.RaftServer.SendMsssage:input_type -> raftpb.Message
	1, // 1: linkall.vanus.raft.RaftServer.SendMsssage:output_type -> google.protobuf.Empty
...
type RaftServerClient interface {
	SendMsssage(ctx context.Context, opts ...grpc.CallOption) (RaftServer_SendMsssageClient, error)
}
...
func (c *raftServerClient) SendMsssage(ctx context.Context, opts ...grpc.CallOption) (RaftServer_SendMsssageClient, error) {
	stream, err := c.cc.NewStream(ctx, &_RaftServer_serviceDesc.Streams[0], "/linkall.vanus.raft.RaftServer/SendMsssage", opts...)
	if err != nil {
		return nil, err
	}
	x := &raftServerSendMsssageClient{stream}
	return x, nil
}

type RaftServer_SendMsssageClient interface {
	Send(*raftpb.Message) error
	CloseAndRecv() (*emptypb.Empty, error)
	grpc.ClientStream
}

type raftServerSendMsssageClient struct {
	grpc.ClientStream
}

func (x *raftServerSendMsssageClient) Send(m *raftpb.Message) error {
	return x.ClientStream.SendMsg(m)
}

func (x *raftServerSendMsssageClient) CloseAndRecv() (*emptypb.Empty, error) {
...
type RaftServerServer interface {
	SendMsssage(RaftServer_SendMsssageServer) error
}
...
func (*UnimplementedRaftServerServer) SendMsssage(RaftServer_SendMsssageServer) error {
	return status.Errorf(codes.Unimplemented, "method SendMsssage not implemented")
}
...
func _RaftServer_SendMsssage_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RaftServerServer).SendMsssage(&raftServerSendMsssageServer{stream})
}

type RaftServer_SendMsssageServer interface {
	SendAndClose(*emptypb.Empty) error
	Recv() (*raftpb.Message, error)
	grpc.ServerStream
}

type raftServerSendMsssageServer struct {
	grpc.ServerStream
}

func (x *raftServerSendMsssageServer) SendAndClose(m *emptypb.Empty) error {
	return x.ServerStream.SendMsg(m)
}

func (x *raftServerSendMsssageServer) Recv() (*raftpb.Message, error) {
...
var _RaftServer_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "SendMsssage",
			Handler:       _RaftServer_SendMsssage_Handler,
			ClientStreams: true,
		},
	},
	Metadata: "raft.proto",
