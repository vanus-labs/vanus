...
type SegmentHealthInfo struct {
	...
	FirstEventBornAt int64 `protobuf:"varint,10,opt,name=first_event_born_at,json=firstEventBornAt,proto3" json:"first_event_born_at,omitempty"`
	// Unix timestamp, unit is millisecond
	LastEventBornAt int64 `protobuf:"varint,11,opt,name=last_event_born_at,json=lastEventBornAt,proto3" json:"last_event_born_at,omitempty"`
}
...
func (x *SegmentHealthInfo) GetFirstEventBornAt() int64 {
	if x != nil {
...
func (x *SegmentHealthInfo) GetLastEventBornAt() int64 {
	if x != nil {
...
var file_meta_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x10, 0x66, 0x69, 0x72, 0x73, 0x74, 0x45, 0x76,
	...
	0x0b, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0f, 0x6c, 0x61, 0x73, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74,
