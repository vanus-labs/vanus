...
func putEvents(offset, eventNum, threadNum int64, eventBody, eventSource string) error {
	var (
		i       int64
...
func Test_e2e_base() {
	...
	putEvents(0, 10000, 100, EventBody, EventSource)
...
func Test_e2e_filter() {
	...
	putEvents(0, 2000, 100, EventBody, EventSource)
	eventSource := "filter"
	putEvents(2000, 4000, 10, EventBody, eventSource)
	eventBody := "{\"key\":\"value\"}"
	putEvents(4000, 4000, 100, eventBody, EventSource)
