...
func TestExactFilter_Filter(t *testing.T) {
	tests := map[string]testAttributeValue{
		"No attribute":   {attribute: "test-attribute", value: "value", expect: FailFilter},
		"No Match value": {attribute: "source", value: "no match value", expect: FailFilter},
